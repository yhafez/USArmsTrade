...
function Instructions () {
  return (
    <section className="insructions">
      ...
      <p className="instructions-info">
      Hover over a country to see the dollar value of the arms that those countries were approved for (authorizations) and the value of the arms that were actually delivered (deliveries). The color of the countries visually represent either the amount of authorizations or deliveries depending on the "Data Type" filter setting. Light gray/purple represent a lower value, and dark purple/blue represent a higher value. Solid grey represents the U.S. (the arms exporter in this data), as well as any countries that have not received arms from the U.S. based on the data used. The "Date Range" filter options can be used to arms export data for a particulare date range. To view data for a single year, simply select that year in the "From" filter and leave the "To" filter on "Date".
      </p>
      <p className="instructions-info">
        The pie chart below shows notifications data divided by region rather than country. As opposed to authorizations and deliveries, notifications are the amount of sales reported to the U.S. congress prior to issuing permits authorizing the specified amount of sales. Hovering over a section of the pie chart displays the name of the region along with the total value of arms exported by the U.S. to that region.
      </p>
    </section>
  )
}
